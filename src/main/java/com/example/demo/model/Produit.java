...
public class Produit {
	...
	private long idPrd;
	@Column(nullable = false, name = "NumeroProduit")
	private int numPrd;
	@Column(nullable = false, name = "NomProduit")
	private String nomPrd;
	@Column(nullable = false, name = "categorie")
	private String categorie;
	@Column(nullable = false)
	private String titre;
	@Column(nullable = false, name = "DescriptionCourte")
	private String descCourte;
	@Column(nullable = false, name = "DescriptionLong")
	...
	@JoinTable(name = "produit_user", joinColumns = {
			@JoinColumn(name = "produit_id") }, inverseJoinColumns = {
