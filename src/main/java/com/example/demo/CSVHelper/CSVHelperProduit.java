...
public class CSVHelperProduit {
	private static UserRepository userRepository;
	  ...
	  static String[] HEADERs = { "NumeroProduit", "NomProduit", "categorie", "titre","DescriptionCourte","DescriptionLong" };
